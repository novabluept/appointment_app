      ...
      child: StreamBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<List<AppointmentModel>> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return MyException(type: MyExceptionType.GENERAL,imagePath: 'images/no_data_image.svg',firstLabel: 'There is no data available',secondLabel: 'You have no appointments completed at the moment.',);
            } else {

...
class MyTextFormField extends ConsumerWidget {
  ...
  const MyTextFormField({super.key, required this.type, required this.textEditingController,
    this.prefixIcon,this.suffixIcon, required this.label, this.isPassword = false,required this.hasError,required this.errorText,
    this.contentPaddingWidth,this.contentPaddingHeight, required this.validator});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    switch (type) {
      case MyTextFormFieldType.GENERAL:
        return generalTextFormField(textEditingController,null,null,label,isPassword,hasError,errorText,contentPaddingWidth ?? 20,contentPaddingHeight ?? 20,validator);
      case MyTextFormFieldType.PREFIX:
        return generalTextFormField(textEditingController,prefixIcon!,null,label,isPassword,hasError,errorText,contentPaddingWidth ?? 20,contentPaddingHeight ?? 20,validator);
      case MyTextFormFieldType.SUFFIX:
        return generalTextFormField(textEditingController,null,suffixIcon!,label,isPassword,hasError,errorText,contentPaddingWidth ?? 20,contentPaddingHeight ?? 20,validator);
      case MyTextFormFieldType.PREFIX_SUFIX:
        return generalTextFormField(textEditingController,prefixIcon!,suffixIcon!,label,isPassword,hasError,errorText,contentPaddingWidth ?? 20,contentPaddingHeight ?? 20,validator);
      case MyTextFormFieldType.PHONE:
        return phoneTextFormField(textEditingController,null,null,label,isPassword,hasError,errorText,contentPaddingWidth ?? 20,contentPaddingHeight ?? 20,validator);
  ...
  Widget generalTextFormField(TextEditingController textEditingController,IconData? prefixIcon,
      IconData? sufixIcon,String label,bool isPassword,bool hasError,String errorText,
  ...
  Widget phoneTextFormField(TextEditingController textEditingController,IconData? prefixIcon,IconData? sufixIcon,
      String label,bool isPassword,bool hasError,String errorText,
      double contentPaddingWidth, double contentPaddingHeight,String? Function(String?)? validator){
